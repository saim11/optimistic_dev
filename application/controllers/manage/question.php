...
class Question extends CI_Controller {
    ...
    public $ws;
    public $tblName 		= 	"question";
    public $pKey			=	"";
    public $colPrefix       =   "question_";
    ...
    public function __construct(){
       ...
       $this->model  =   array(
											...
											,array('name' => 'count'
                                               ...
                                               ,'required' => true
                                               ,'icon' => 'entypo-docs'
                                               , 'query'=>"SELECT COUNT(`option_id`) AS 'count' FROM `option` WHERE `option_question`='@value@'"
                                               , 'detail_link'=>'manage/option?option_question=@value@'
                                               )
											 ,array('name' => 'question_test'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Test Details'
                                            ,'type' => 'detail'
                                            ,'required' => true
                                            , 'list'=>array()
                                            , 'detail_link'=>'manage/test/control/edit/'
                                            ,'icon' => 'entypo-doc-text-inv'
                                            )
                                             ,array('name' => 'question_type'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Type'
                                            ,'type' => 'select'
