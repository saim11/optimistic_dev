...
class Menu extends CI_Controller {
    ...
    */
	...
	public function __construct(){
		...
		$menu_Array=$this->SqlModel->runQuery("select menu_id as 'value',menutitle as 'show' from menu");
		array_push($menu_Array,array('value' => '0','show' => 'No'));
		$this->model =   array(
			array('name' => 'menutitle'
			,'view_update' => true
			,'view_list' => true
			,'view_name' => 'title'
			,'type' => 'text'
		...
		,array('name' => 'parent_menu'
			,'view_update' => true
			,'view_list' => true
			,'view_name' => 'Parent menu'
			,'type' => 'select'
			,'required' => true
			, 'list'=>$menu_Array
			)
		,array('name' => 'menu_status'
			,'view_update' => true
			,'view_list' => true
			,'view_name' => 'status'
			,'type' => 'select'
