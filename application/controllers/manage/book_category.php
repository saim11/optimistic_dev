...
class Book_category extends CI_Controller {
    ...
    public $pKey			=	"";
    public $colPrefix       =   "book_category_";
    public $moduleName 		=	"Book Category";
    public $controller 		=	"";
    public $per_page 		=	"10";
    public $tStatus 		=	"";
    ...
    */
    ...
    public function __construct(){
       ...
       $this->model  =   array(
                                            ...
                                            array('name' => 'book_category_title'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Title'
                                            ,'type' => 'text'
                                            ...
                                            array('name' => 'book_category_image'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Image'
                                            ,'type' => 'image'
											...
											,array('name' => 'count'
                                               ...
                                               ,'required' => true
                                               ,'icon' => 'entypo-docs'
                                               , 'query'=>"SELECT COUNT(`book_id`) AS 'count' FROM `book` WHERE `book_category`='@value@'"
                                               , 'detail_link'=>'manage/book?book_category=@value@'
                                               )
                                            ,array('name' => 'book_category_status'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Status'
                                            ,'type' => 'select'
