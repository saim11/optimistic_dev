...
class Book extends CI_Controller {
    ...
    */
    ...
    public function __construct(){
        ...
        //$this->drop_table();
        //$this->create_table();
        $book_category_Array=$this->SqlModel->runQuery("select book_category_id as 'value',book_category_title as 'show' from book_category");
       $this->model  =   array(

                                            
                                            array('name' => 'book_title'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Title'
                                            ,'type' => 'text'
                                            ...
                                            ,array('name' => 'book_category'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Category'
                                            ,'type' => 'select'
                                            ,'required' => true
                                            , 'list'=>$book_category_Array
                                            )
                                            ,array('name' => 'book_category_id'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Category'
                                            ,'type' => 'hidden'
    ...
    public function addRecord()
    {
        ...
        $a = array("book_category_id"=>$data['book_category']);
        $data = array_replace($data,$a);
