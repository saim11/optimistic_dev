...
class Answer extends CI_Controller {
    ...
    public $ws;
    public $tblName 		= 	"answer";
    public $pKey			=	"";
    public $colPrefix       =   "answer_";
    public $moduleName 		=	"Answer";
    public $controller 		=	"";
    public $per_page 		=	"10";
    public $tStatus 		=	"";
    ...
    public function __construct(){
       ...
       $this->model  =   array(
											...
											,array('type' => 'custom_query'
                                              ,'name' => 'Test'
                                              ,'view_name' => 'Test'
                                              ,'map_field' => 'answer_test'
                                              ,'query' => "SELECT test_title as 'Title' from test WHERE test_id='@value@'"
                                              ,'view_update' => false
                                              ,'view_list' => true
                                             )
                                            ,array('type' => 'custom_query'
                                              ,'name' => 'User'
                                              ,'view_name' => 'User'
                                              ,'map_field' => 'answer_user'
                                              ,'query' => "SELECT user_name as 'Name',user_email as 'Email' from user WHERE  user_id='@value@'"
                                              ,'view_update' => false
                                              ,'view_list' => true
                                             )
                                            ,array('name' => 'answer_status'
                                            ,'view_update' => true
                                            ,'view_list' => true
                                            ,'view_name' => 'Status'
                                            ,'type' => 'select'
