...
class Blog extends CI_Controller {
    ...
    public $moduleName 		=	"Blog/Event/News";
    public $controller 		=	"";
    public $per_page 		=	"10";
    public $tStatus 		=	"";
    ...
    */
    ...
    public function __construct(){
        ...
        ,array('name' => 'blog_feature_image'
            ,'view_update' => true
            ,'view_list' => true
            ,'view_name' => 'Feature image'
            ,'type' => 'image'
            ,'required' => true
            , 'list'=>array()
            )
        ,array('name' => 'blog_details'
            ,'view_update' => true
            ,'view_list' => false
            ,'view_name' => 'Details'
            ,'type' => 'rte'
        ...
        ,array('name' => 'custom_date'
            ,'view_update' => true
            ,'view_list' => false
            ,'view_name' => 'custom date'
            ,'type' => 'date'
            ,'required' => true
            , 'list'=>array()
            )
        ...
        /**,array('name' => 'count'
            ...
            ,'required' => true
            ,'icon' => 'entypo-docs'
            , 'query'=>"select count(comments_id) as count from comments where comments_blog_id='@value@'"
            , 'detail_link'=>'manage/comments?comments_blog_id=@value@'
            )*/
