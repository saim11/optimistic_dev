  ...
  <div class="slider_sub">
    <div class="bd-example">
      <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active"> <img src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/slide_1.jpg"
...
<div class="carousel_area">
      ...
      <div id="second" class="carouseller"> <a href="javascript:void(0)" class="carouseller__left">‹</a>
        <div class="carouseller__wrap">
          <div class="carouseller__list">
            ...
            <div class="car__3"> <a href="http://dev.softkodes.com/optimisticfuture/individual-support.html"><img
            ...
            <div class="car__3"> <a href="#"><img src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/caro_5.jpg"
                  alt=""></a> </div>
            <div class="car__3"> <a
                href="http://dev.softkodes.com/optimisticfuture/chc30113-certificate-iii-in-early-childhood-education-and-care.html"><img
                  src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/caro_1.jpg" alt=""></a> </div>
  ...
  <div class="student_heading">
    <div class="student_heading_sub">
      ...
      <div class="normal_text">
        <p>At the Optimistic Future, To promote life-long learning,<br> Tech employability skills, encourage continuous
          professional
  ...
  <div class="three_section">
    <div class="three_section_sub">
      <div class="section_one">
        ...
        <img src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/traning_image.jpg" alt="" class="mobile_image">
        <h2>Login to Online Testing</h2>

        <form>
          <div class="form-group">
            <input type="email" class="form-control my_login" id="exampleInputEmail1" aria-describedby="emailHelp"
              placeholder="Email">

          </div>
          <div class="form-group">
            <input type="password" class="form-control my_login" id="exampleInputPassword1" placeholder="Password">
          </div>
          <div class="form-group form-check my_check">
            <input type="checkbox" class="form-check-input" id="exampleCheck1">
            <label class="form-check-label" for="exampleCheck1">Remember Me</label>
          </div>
          <button type="submit" class="btn btn-success my_submit">Sign In</button>
      ...
      <div class="section_two">
        <a href="http://dev.softkodes.com/optimisticfuture/cpp20212-certificate-ii-in-security-operations.html"><img
            src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/1.jpg" alt="" class="section2_img mobile_image"></a>
      ...
      <div class="section_three">
        ...
        <a href="http://dev.softkodes.com/optimisticfuture/hltaid001-provide-cardiopulmonary-resuscitation.html"><img
            src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/5.jpg" alt="" class="section3_img mobile_image"></a>
  ...
  <div class="our_partner">
    <div class="our_partner_sub"> <img class="image_res"
        ...
        class="<?php echo FRONTEND_ASSETS; ?>front-pages/image_res"
        src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/partner4.jpg" alt=""> </div><!-- our_partner_sub-->
  </div><!-- our_partner-->
  ...
  <div class="client_section">
    <div class="client_section_sub">
          ...
          <div id="third" class="carouseller">
            <div class="carouseller__wrap">
              <div class="carouseller__list">
                ...
                <div class="car__4">
                  <p>"If you are looking to earn an early childhood teaching credential or certificate, then you are at
                    the right place! <br>
                    <br> Optimistic Futures’s teachers have given me ongoing support and knowledge that lead me to start
                    an honourable career of a primary teacher. I hope students will get influence and gain a better
                    future."<br>
                    <br>
                ...
                <div class="car__4">
                  <p>"It has been an amazing studying and working experience at Optimistic Futures that not only monitor
                    educational growth, also social development. They offer complete diploma in early childhood
                    education
                    and care at the most reasonable course fee. They are running a top notch educational programs that
                    include physical working environment so that students could implement their practices in a
                    professional
                    atmosphere."
                    <br>
                    <br>
                ...
                <div class="car__4">
                  <p>"I am very pleased to study and completed my certificate course in security operation here. During
                    this time, I met some great friends and teachers. Their certificate is considered reliable and
                    authentic
                    in the security industry. After completing my course certificate, I got enough job opportunities,
                    and
      ...
      <div class="client_img">
        <img class="mobile_image" src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/client_section.jpg" alt="">
      </div><!-- client_img-->
