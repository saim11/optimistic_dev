		...
		<div id="divtoconvert" class="container" style="background-color: white; ">
			<div class="row Add_details">
					...
					<form id="contactForm" method="post" action="" class="validate">
							...
							<div class="col-sm-9">
								<div class="Office-checks">
									<div class="checkbox">
										...
										<label for="box6">Classroom</label>
									</div>
								</div>
								<div class="Office-checks">
									<div class="checkbox">
										<input id="box7" type="checkbox" />
										<label for="box7">Distance Learning</label>
									</div>
								</div>
								<div class="Office-checks">
									<div class="checkbox">
										<input id="box8" type="checkbox" />
										<label for="box8">Online</label>
									</div>
								</div>
								<div class="Office-checks">
									<div class="checkbox">
										<input id="box9" type="checkbox" />
										<label for="box9">RPL</label>
									</div>
								</div>
								<div class="Office-checks">
									<div class="checkbox">
										<input id="box10" type="checkbox" />
										<label for="box10">CT</label>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col-sm-10">
									<div class="Office-checks">
										<div class="checkbox">
											...
											<label for="box11">Mr.</label>
										</div>
									</div>
									<div class="Office-checks">
										<div class="checkbox">
											<input id="box12" type="checkbox" />
											<label for="box12">Mrs.</label>
										</div>
									</div>
									<div class="Office-checks">
										<div class="checkbox">
											<input id="box13" type="checkbox" />
											<label for="box13">Miss</label>
										</div>
									</div>
									<div class="Office-checks">
										<div class="checkbox">
											<input id="box14" type="checkbox" />
											<label for="box14">Ms</label>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-sm-10">
									<div class="Office-checks">
										<div class="checkbox">
											...
											<label for="box15">Male</label>
										</div>
									</div>
									<div class="Office-checks">
										<div class="checkbox">
											<input id="box16" type="checkbox" />
											<label for="box16">Female</label>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="one" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="two" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="three" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="four" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" id="five" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" id="six" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label>State:</label>
								<input type="text" id="seven" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" id="eight" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" id="nine" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<input type="text" id="ten" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label>Mobile:</label>
								<input type="text" id="eleven" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label>Fax:</label>
								<input type="text" id="twelve" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label>Email:</label>
								<input type="text" id="thirteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Name:</label>
								<input type="text" id="forteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="fifteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="sixteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Mobile:</label>
								<input type="text" id="seventeen" class="form-control Form_Setup required">
							</div>
						</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="checkbox">
										...
										<label for="box17">Yes</label>
									</div>

									<div class="checkbox">
										<input id="box18" type="checkbox" />
										<label for="box18">No</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="eighteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="ninteen" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="twenty" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Expiry date:</label>
								<input type="text" id="twentyOne" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="twentyTwo" class="form-control Form_Setup required">
									<br />
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" id="twentyThree" class="form-control Form_Setup required">
									<br />
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<label>VSN:</label>
									<input type="text" id="twentyFour" class="form-control Form_Setup required">
									<br />
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<input type="text" id="twentyFive" class="form-control Form_Setup required">
									<br />
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="checkbox">
								...
								<label for="box20">Full-Time</label>
							</div>
							<div class="checkbox">
								<input id="box21" type="checkbox" />
								<label for="box21">Employer</label>
							</div>
							<div class="checkbox">
								<input id="box22" type="checkbox" />
								<label for="box22">Part-Time</label>
							</div>
							<div class="checkbox">
								<input id="box23" type="checkbox" />
								<label for="box23">Self-employed - not employing others</label>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="checkbox">
								...
								<label for="box24">Unemployed - Seeking full-time work</label>
							</div>
							<div class="checkbox">
								<input id="box25" type="checkbox" />
								<label for="box25">Employed - Unpaid worker in a family business</label>
							</div>
							<div class="checkbox">
								<input id="box26" type="checkbox" />
								<label for="box26">Unemployed - Seeking part-time work</label>
							</div>
							<div class="checkbox">
								<input id="box27" type="checkbox" />
								<label for="box27">Not employed - Not seeking employment</label>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="twentySix" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="twentySeven" class="form-control Form_Setup required">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label>Address:</label>
								<input type="text" id="twentyEight" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="text" id="twentyNine" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>ABN:</label>
								<input type="text" id="thirty" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="checkbox">
								<input id="box28" type="checkbox" />
								<label for="box28">Year 12 or equivalent</label>
							</div>
							<div class="checkbox">
								<input id="box29" type="checkbox" />
								<label for="box29">Year 9 or equivalent</label>
							</div>
						</div>

						<div class="col-sm-4">
							<div class="checkbox">
								<input id="box30" type="checkbox" />
								<label for="box30">Year 11 or equivalent</label>
							</div>
							<div class="checkbox">
								<input id="box31" type="checkbox" />
								<label for="box31">Year 8 or equivalent</label>
							</div>
						</div>

						<div class="col-sm-4">
							<div class="checkbox">
								<input id="box32" type="checkbox" />
								<label for="box32">Year 10 or equivalent</label>
							</div>
							<div class="checkbox">
								<input id="box33" type="checkbox" />
								<label for="box33">Never Attended</label>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" id="thirtyOne" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-8">
							<div class="checkbox">
								<input id="box34" type="checkbox" />
								<label for="box34">Year 10 or equivalent</label>
							</div>
							<div class="checkbox">
								<input id="box35" type="checkbox" />
								<label for="box35">Never Attended</label>
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box36" type="checkbox" />
									<label for="box36">Yes</label>
								</div>
							</div>
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box37" type="checkbox" />
									<label for="box37">No</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-3">
							<div class="checkbox">
								<input id="box38" type="checkbox" />
								<label for="box38">Certificate I</label>
							</div>
							<div class="checkbox">
								<input id="box39" type="checkbox" />
								<label for="box39">Certificate II</label>
							</div>
							<div class="checkbox">
								<input id="box40" type="checkbox" />
								<label for="box40">Certificate II</label>
							</div>
						</div>

						<div class="col-sm-5">
							<div class="checkbox">
								<input id="box41" type="checkbox" />
								<label for="box41">Certificate III (or Trade Certificate)</label>
							</div>
							<div class="checkbox">
								<input id="box42" type="checkbox" />
								<label for="box42">Certificate IV (or Advance Certificate/ Technician)</label>
							</div>
							<div class="checkbox">
								<input id="box43" type="checkbox" />
								<label for="box43">Diploma (or Associate Diploma)</label>
							</div>
						</div>

						<div class="col-sm-4">
							<div class="checkbox">
								<input id="box44" type="checkbox" />
								<label for="box44">Advance diploma or Associcate Degree</label>
							</div>
							<div class="checkbox">
								<input id="box45" type="checkbox" />
								<label for="box45">Bachelor degree or Higher degree</label>
							</div>
							<div class="checkbox">
								<input id="box46" type="checkbox" />
								<label for="box46">Certificates other than the above</label>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" id="thirtyTwo" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-5">
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box47" type="checkbox" />
									<label for="box47">Australia</label>
								</div>
							</div>
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box48" type="checkbox" />
									<label for="box48">Overseas</label>
								</div>
							</div>
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box49" type="checkbox" />
									<label for="box49">Australian equivalent</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>other:</label>
								<input type="text" id="thirtyThree" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								...
								<input type="text" id="thirtyFour" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="checkbox">
								<input id="box51" type="checkbox" />
								<label for="box51">No, only English</label>
							</div>
							<div class="checkbox">
								<input id="box52" type="checkbox" />
								<label for="box52">Yes,(Please speicfy)</label>
							</div>
							<div class="checkbox">
								<input type="text" id="thirtyFive" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="checkbox">
								<input id="box53" type="checkbox" />
								<label for="box53">Very well</label>
							</div>
							<div class="checkbox">
								<input id="box54" type="checkbox" />
								<label for="box54">Well</label>
							</div>
							<div class="checkbox">
								<input id="box55" type="checkbox" />
								<label for="box55">Not Well</label>
							</div>
							<div class="checkbox">
								<input id="box56" type="checkbox" />
								<label for="box56">Not at All</label>
							</div>
						</div>
						...
						<div class="col-sm-4">
							...
							<div class="checkbox">
								<input id="box57" type="checkbox" />
								<label for="box57">No</label>
							</div>
							<div class="checkbox">
								<input id="box58" type="checkbox" />
								<label for="box58">Yes, Aboriginal</label>
							</div>
							<div class="checkbox">
								<input id="box59" type="checkbox" />
								<label for="box59">Yes, Torres Strait Islander</label>
							</div>
							<div class="checkbox">
								<input id="box60" type="checkbox" />
								<label for="box60">Yes, Both</label>
							</div>
						</div>
						...
						<div class="col-sm-4">
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box61" type="checkbox" />
									<label for="box61">Yes</label>
								</div>
							</div>
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box62" type="checkbox" />
									<label for="box62">No</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							...
							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box63" type="checkbox" />
									<label for="box63">Hearing/Deaf</label>
								</div>
								<div class="checkbox">
									<input id="box64" type="checkbox" />
									<label for="box64">Physical</label>
								</div>
								<div class="checkbox">
									<input id="box65" type="checkbox" />
									<label for="box65">Intellectual</label>
								</div>
							</div>

							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box66" type="checkbox" />
									<label for="box66">Learning</label>
								</div>
								<div class="checkbox">
									<input id="box67" type="checkbox" />
									<label for="box67">Mental Illness</label>
								</div>
								<div class="checkbox">
									<input id="box68" type="checkbox" />
									<label for="box68">Vision</label>
								</div>
							</div>

							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box69" type="checkbox" />
									<label for="box69">Medical Condition</label>
								</div>
								<div class="checkbox">
									<input id="box70" type="checkbox" />
									<label for="box70">Acquired brain impairment</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label>Other:</label>
								<input type="text" id="thirtySix" class="form-control Form_Setup required">
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box71" type="checkbox" />
									<label for="box71">To get a job</label>
								</div>
								<div class="checkbox">
									<input id="box72" type="checkbox" />
									<label for="box72">To start my own business</label>
								</div>
								<div class="checkbox">
									<input id="box73" type="checkbox" />
									<label for="box73">It was a requirement of my job</label>
								</div>
								<div class="checkbox">
									<input id="box74" type="checkbox" />
									<label for="box74">For personal interest or self-development</label>
								</div>
							</div>

							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box75" type="checkbox" />
									<label for="box75">To develop my existing business</label>
								</div>
								<div class="checkbox">
									<input id="box76" type="checkbox" />
									<label for="box76">To try for a different career</label>
								</div>
								<div class="checkbox">
									<input id="box77" type="checkbox" />
									<label for="box77">I wanted extra skills for my job</label>
								</div>
							</div>

							<div class="col-sm-4">
								<div class="checkbox">
									<input id="box78" type="checkbox" />
									<label for="box78">Other reason</label>
								</div>
								<div class="checkbox">
									<input id="box79" type="checkbox" />
									<label for="box79">To get a better job or promotion</label>
								</div>
								<div class="checkbox">
									<input id="box80" type="checkbox" />
									<label for="box80">To get into another course or study</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-12">
							<div class="col-sm-6">
								<div class="checkbox">
									<input id="box82" type="checkbox" />
									<label for="box82">Drivers licence</label>
								</div>
								<div class="checkbox">
									<input id="box83" type="checkbox" />
									<label for="box83">Passport</label>
								</div>
								<div class="checkbox">
									<input id="box84" type="checkbox" />
									<label for="box84">Proof of age card</label>
								</div>
								<div class="checkbox">
									<input id="box85" type="checkbox" />
									<label for="box85">Learners Permit</label>
								</div>
							</div>

							<div class="col-sm-6">
								<div class="checkbox">
									<input id="box86" type="checkbox" />
									<label for="box86">Birth certification</label>
								</div>
								<div class="checkbox">
									<input id="box87" type="checkbox" />
									<label for="box87">Medicare card</label>
								</div>
								<div class="checkbox">
									<input id="box88" type="checkbox" />
									<label for="box88">Health Care card</label>
								</div>
								<div class="checkbox">
									<input id="box89" type="checkbox" />
									<label for="box89">Credit card</label>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							...
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box90" type="checkbox" />
									<label for="box90">Yes</label>
								</div>
							</div>
							<div class="Office-checks">
								<div class="checkbox">
									<input id="box91" type="checkbox" />
						...
						<div class="col-sm-12">
							<div class="checkbox">
								<input id="box98" type="checkbox" />
								<label for="box98">Yes</label>
							</div>
							<div class="checkbox">
								<input id="box99" type="checkbox" />
								<label for="box99">No</label>
							</div>
						</div>
							...
							<div class="col-sm-2">
								<div class="Office-checks">
									<div class="checkbox">
										...
										<label for="box106">Yes</label>
									</div>
								</div>
								<div class="Office-checks">
									<div class="checkbox">
										<input id="box107" type="checkbox" />
										<label for="box107">No</label>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="row Add_details">
						<div class="col-md-12 col-sm-12">
							<a class="btn btn-default Submit_Button" type="button" onClick="hello()">SUBMIT</a>
						</div>
					</div>
				</div>
	</section>
