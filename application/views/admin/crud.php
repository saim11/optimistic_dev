                  ...
                  <td>
                   ...
                   <?php  } else if($cols['type'] != 'action') { ?>
					...
					<?php } else{
						   ...
						   ?>
				  		<td> 
						    <a class="icon-left font16 inoti" target="_blank" href="<?php echo base_url($cols['detail_link']); ?>">
							   <i class="<?php echo $cols['icon']; ?>"></i><?php echo (isset($c['count']) && (int)$c['count']>0) ? '<span class="badge badge-secondary">'.$c['count'].'</span>' : '';?>
							</a>
				  		</td>
                  <?php } } } ?>
