	...
	<div class="col-md-12">
		...
		<?php
		 ...
		 foreach($listing as $data){
			 if($data['user_status']=="Pending" && $data['user_type'] == "student"){
				$count = $count + 1;
			 }
			 if($data['user_status']=="Pending" && $data['user_type'] == "trainer"){
				 $countTrainer = $countTrainer+1;
			 }
		 }
		 ?>
		...
		<ul class="nav nav-tabs" role="tablist">
  			<li class="active"><a href="#home" role="tab" data-toggle="tab">Students <span class="badge" style="background-color:#228B22;color:white"><?php echo $count ?></span></a></li>
  			<li><a href="#profile" role="tab" data-toggle="tab">Trainers <span class="badge" style="background-color:red;color:white"><?php echo $countTrainer ?></span></a> </li>
		</ul>
		  ...
		  <div class="tab-pane active" id="home">      
			...
			<table id="table-<?php echo $this->controller;?>" class="table table-hover table-striped">
				...
				if(count($listing)>0 )
				{
					...
					foreach($listing as $c)
					{
						...
						if($c['user_type'] == 'student' && $c['user_status'] != 'Active'){
			...
			<table id="table-<?php echo $this->controller;?>" class="table table-hover table-striped">
				...
				if(count($listing)>0 )
				{
					foreach($listing as $c)
					{						
						if($c['user_type'] == 'trainer' && $c['user_status'] != "Active"  ){
