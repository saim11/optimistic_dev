...
<?php 
// print_r($form_apply3);	
// 	$enrolCoursesChecked = explode(",", $form_apply3['enrollment_course']);
	
// 	$coursesArray = array("CHC30113", "CHC50113", "CPP20212", "CPP30411", "CHC33015");
// 	//$enrolCoursesChecked = array("CPP20212", "CPP30411");
// 	print_r($enrolCoursesChecked);
// 	$num=1;
// 	foreach ($coursesArray as $cour) {
// 	$checked="";
	
// 	print_r($num++);
// 	if(in_array($cour, $enrolCoursesChecked)){
// 	// print_r($enrolmentCoursesChecked);
// 		print_r($cour);
// 	  $checked = "checked";
// 	// print_r("in if");
// 	  //print_r($checked);
// 	}
// 	// echo '<input type="checkbox" name="enrollment_course[]" value="'.$cour'" '.$checked.' >';
// 	// echo '<input id="box1" type="checkbox" name="enrollment_course[]" value="'.$cour.'" '.$checked.' > '.$cour.' <br/>';
// 	echo '<input id="box1" type="checkbox" name="enrollment_course[]" value="'.$cour.'" '.$checked.' > ';
// 	echo '<label for="box1">'.$cour.'</label>';
// }
?>

<div class="panel panel-success row Add_details">
			<h3 class="form-heading">SKILLS FIRST PROGRAM ENROLMENT AGREEMENT FORM</h3>
</div>
<!-- Head_Titles Closed -->
<div id="Approved">
</div>
...
<section class="">
		<div id="divtoconvert" class="" style="background-color: white; ">
			<div class="row Add_details">
				<div class="col-md-12 col-sm-8 Contact_Add Appy-formy">
				...
				<div class="container">
					<div class="row Add_details">
						<div class="col-md-12 col-sm-12">
							<a class="btn btn-default Submit_Button" type="button" id='download' onclick="form_attestation(<?php echo $form_apply3['enrol']['id']; ?>,<?php echo $form_apply3['enrol']['user_id']; ?>,this.id, '<?php echo $form_apply3['enrol']['submission_date']; ?>'); ello();">SUBMIT</a>
							<a class="btn btn-default Approve_Button" href="#Approved" id="approve" onclick="form_attestation(<?php echo $form_apply3['enrol']['id']; ?>,<?php echo $form_apply3['enrol']['user_id']; ?>,this.id,'<?php echo $form_apply3['enrol']['submission_date']; ?>');">APPROVE</a>
	...
	$('.changeOption').change(function(){
		...
		$.ajax({
			...
			data: {
				...
				user_id: <?php echo $form_apply3['enrol']['user_id']?>,
				form_id: <?php echo $form_apply3['enrol']['id']?>,

			},
			url: '<?php echo site_url('application_forms_update/form_apply3_enrolmentCourse') ?>',
	...
	// textboxes data start
		$('.textChange').keyup(function(){
			...
			$.ajax({
				...
				url: '<?php echo site_url('application_forms_update/form_apply3_enrolmentCourse2') ?>',
				success: function(result){
		    		console.log(result);
		    	},
			})
	...
	$('#approve').click(()=>{
		$.ajax({
				...
				url: '<?php echo site_url('application_forms_update/form3_approval') ?>',
				success: function(result){
...
<script src='<?php echo base_url(); ?>ofpdfs/f3/js/form_attested.js'></script>
