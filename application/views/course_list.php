                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="card" style="border:none;">
                                <a
                                    href="<?php echo base_url() . 'trainer_books.html?book_category=' . $book_category["content_id"]; ?>">
                                    <img src="<?php echo base_url() . $book_category["content_image"] ?>"
                                        class="card-img-top" width="150" height="170" alt="">
                                </a>
                                <div class="card-body">
                                    <h6><?php echo $book_category["content_title"]; ?></h6>
                                </div>
                            </div>
                            <br /><br /><br />
                        </div>
