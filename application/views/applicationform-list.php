...
<div class="osc">
    <div class="ocs_sub">
        <!--Carousel Wrapper-->
        <img src="<?php echo FRONTEND_ASSETS; ?>front-pages/images/slider_login.jpg" class="img-fluid"
                    ...
                    <table class="table table-bordered Listing">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Form Discription</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align:middle;"><a
                                        href="<?php echo base_url() . 'form-apply1.html'; ?>"
                                        class="btn btn-default my_fill_btn">Fill now</a></td>
                            </tr>

                            <tr>
                                <td>Enrollment Booklet</td>
                                <td>Enrollment Booklet</td>
                                <td class="text-center" style="vertical-align:middle;"><a
                                        href="<?php echo base_url() . 'form-apply2.html'; ?>"
                                        class="btn btn-default my_fill_btn">Fill now</a></td>
                            </tr>

                            <tr>
                                <td>Skills First Program Enrolment Agreement Form</td>
                                <td>Skills First Program Enrolment Agreement Form</td>
                                <td class="text-center" style="vertical-align:middle;"><a
                                        href="<?php echo base_url() . 'form-apply3.html'; ?>"
                                        class="btn btn-default my_fill_btn">Fill now</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Student Induction Form</td>
                                <td class="text-center" style="vertical-align:middle;"><a
                                        href="<?php echo base_url() . 'form-apply4.html'; ?>"
                                        class="btn btn-default my_fill_btn">Fill now</a></td>
                            </tr>
