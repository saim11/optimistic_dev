                ...
                <div class="card gedf-card content_data">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mr-2">
                                    <img class="rounded-circle" width="55" src="http://dev.softkodes.com/uploads/ckeditor/optimistic-futures/images/optimistic_logo.png" alt="">
                                </div>
                                <div class="ml-2">
                                    <div class="h5 m-0">Cloud Engineer</div>
                                    <div class="h7 text-muted">Sales and Account Management</div>
                                    <div class="h7 text-muted">Melbourne</div>
                                </div>
                            </div>
                            <div>
                                <div class="dropdown">
