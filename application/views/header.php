...
<body>
            ...
            <div class="top_bar_nav">
                <ul class="nav my_top_nav">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            href="http://dev.softkodes.com/optimisticfuture/about-us.html">About
                            Us</a> </li>
                    <li class="nav-item"> <a class="nav-link"
 ...
 if ($this->session->userdata('user_type') == 'trainer') {?>
                        <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle loggedIn" href="#"
                                id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false"><?php echo $this->session->userdata('user_name'); ?></a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                    href="<?php echo $this->config->base_url() . 'home/logout'; ?>"><span
  ...
  ?>
                        ...
                        <li class="Menu-dropdown">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-sm login_btn"
                                ...
                                <ul class="dropdown-menu " role="menu">
                                    ...
                                    <li><a href="<?php echo $this->config->base_url() . 'home/logout'; ?>"><span
                                                class="glyphicon glyphicon-off" style="padding-right:5px"></span>Log
                                            Out</a></li>
                                </ul>
                            </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light desk_nav" id="main_navbar">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item "> <a class="nav-link"
                                    href="http://dev.softkodes.com/optimisticfuture/student-info.html">Student
                                    Information<span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="http://dev.softkodes.com/optimisticfuture/application-form.html">Application
                                    Forms</a> </li>


                            <!-- Talal Customization start -->
                            <li class="nav-item">
                                <a class="nav-link" href="http://dev.softkodes.com/optimisticfuture/join_us.html">Join
                                    Us</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="http://dev.softkodes.com/optimisticfuture/blogs">Blog</a>
                            </li>
                            <!-- Talal Customization end -->


                            <li class="nav-item"> <a class="nav-link"
                                    href="http://dev.softkodes.com/optimisticfuture/details-and-schedule.html">Details
                                    and Schedule</a>
                            </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown1">
                                            <li><a class="dropdown-item"
                                                    href="http://dev.softkodes.com/optimisticfuture/individual-support.html">CHC33015
                                                    Cert III</a>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="LOGINForm" method="post"
                        action="<?php echo $this->config->base_url() . 'home/forgotpassword'; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name-company" name="user_email"
                                        class="form-control Form_Setup required" placeholder="Email/Username">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" id="submitBtn"
                                        class="btn btn-default Submit_Button">SUBMIT</button>
