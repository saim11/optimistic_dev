...
var DFLightBox = (function DFLightBoxClosure($) {
  ...
  function DFLightBox(closeCallback, options) {
    console.log("hfduuuuuuudsssssssssssssssssssssss");
    ...
    _this.closeButton = $("<div>").addClass(" ")
      .on("click", function () {
        console.log("hfduuuuuuudsssssssssssssssssssssss");
...
// Customization from saim
  $('body.page-id-4305 .blog-slider-2 .item').each(function () {
    var $slide = $(this);
    var $good_link = $slide.find('.news-v12-title a');
    var $bad_link = $slide.find('a.ff-post-featured-image-link-wrapper');

    $good_link.attr('target', '_blank');
    $bad_link.attr('target', '_blank');
    $bad_link.removeClass('image-popup-up');

    $bad_link.attr('href', $good_link.attr('href'));
  });
