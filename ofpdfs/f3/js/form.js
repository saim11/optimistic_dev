...
let hello = () => {
    ...
    fortySix = document.getElementById('govtEnrolCourses').value.toUpperCase();
    fortySeven = document.getElementById('sameLevelGovtFundedCourses').value.toUpperCase();
    ...
    var docDefinition = {
        ...
        footer: function(currentPage, pageCount) {
            ...
            return {
                ...
                table: {
                    ...
                    widths: [60, 70, 350, 50],
                    body: [
                        [{ text: "", border: [false, false, false, false] }, { text: "", border: [false, true, false, false] }, { text: "Optimistic Futures Pty Ltd TOID:41053 | Skills First Program Enrolment Agreement Form – APRIL 19 – V2.7", fontSize: 7, border: [false, true, false, false], }, { text: currentPage.toString(), alignment: 'center', fontSize: 9, color: 'white', fillColor: "#933131", border: [false, true, false, false] }]
                    ]
        ...
        content: [{
            ...
            {
                style: "paragraph",
                text: 'STUDENT INFORMATION SHEET ',
                bold: true,
                alignment: "left",
                fontSize: 12
            },
            ...
            '\n',
            {
                table: {
                    ...
                    body: [
                        [{
                            text: 'PERSONAL DETAILS (Legal name as per photo ID, which will need to be sighted to verify legal name)',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
                ...
                table: {
                    ...
                    body: [
                        [{
                            ...
                            {
                                text: 'Prefered method of contact:',
                                bold: true,
                                style: "textSmall",
                                alignment: 'center',
                                border: [false, false, false, false]
            ...
            },
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'costs related to the emergency?',
                                bold: true,
                                style: "textSmall",
                                fontSize: 8.7,
                                bold: true,
            ...
            "\n",
            {
                table: {
                    ...
                    body: [
                        [{
                            text: 'VICTORIAN STUDENT NUMBER (VSN)',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
            ...
            "",
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'A. Of the following categories, which BEST describes your current employment status?',
                                bold: true,
                                style: "textSmall",
                            },
                            {
                                text: 'Tick ONE box only',
                                bold: true,
                                color: 'grey',
                                style: "textSmall",
                            },
            ...
            "",
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'B. Which of the following classification BEST describes your current or recent occupation? Tick ONE box only',
                                bold: true,
                                style: "textSmall",
                            },
                            {
            ...
            "",
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'C.   Which of the following classification BEST describes the industry of your current or previous Employer?',
                                bold: true,
                                style: "textSmall",
                            },
                            {
            ...
            // End Second
            {
                ...
                table: {
                    ...
                    body: [
                        [{
                            text: 'EMPLOYMENT DETAILS (if applicable)',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
            ...
            "\n",
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'What is your highest COMPLETED school Level:',
                                bold: true,
                                style: "textSmall",
                            },
                            {
                                text: 'Please tick ONE box only',
                                bold: true,
                                color: 'grey',
                                style: "textSmall",
                            },
            ...
            },
            {
                table: {
                    ...
                    body: [
                        [{
                                margin: [0, 4, 0, 0],
                                text: 'In which YEAR did you complete that Schooling Level:',
                                bold: true,
                                style: "textSmall",
                                alignment: 'left',
                                border: [false, false, false, false]
            ...
            "\n\n",
            {
                table: {
                    ...
                    body: [
                        [{
                            text: 'PREVIOUS QUALIFICATIONS ACHIEVED',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
            ...
            },
            {
                table: {
                    ...
                    body: [
                        [{
                                text: 'Details of another Certificate: ',
                                bold: true,
                                style: "textSmall",
                                alignment: 'left',
                                border: [false, false, false, false]
            ...
            "\n",
            {
                table: {
                    ...
                    body: [
                        [{
                            text: 'LANGUAGE & CULTURAL DIVERSITY',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
            ...
            "\n",
            {
                text: 'Fee Concession or Fee Waivers',
                bold: true,
                style: "textSmall",
            },
            "\n",
            ...
            "\n",
            {
                text: 'If yes which of the following has been sighted?',
                style: "textSmall",
                bold: true
            },
            {
            ...
            '\n',
            {
                table: {
                    ...
                    body: [
                        [{
                            text: 'TERMS & CONDITIONS OF ENROLMENT',
                            fillColor: "#484848",
                            color: 'white',
                            bold: true,
                            style: "textSmall",
            ...
            "\n",
            {
                ...
                columns: [
                    ...
                    [
                        ...
                        {
                            text: 'All students undertaking a Certificate III qualification or below are required to undertake an LLN Assessment.',
                            margin: [7, 3, 10, 0],
                        },
            ...
            '\n',
            {
                ...
                table: {
                    ...
                    body: [
                        [{
                            text: 'Student Declaration and Consent',
                            fillColor: "#484848",
                            color: 'white',
                            alignment: 'center',
                            fontSize: 14,
            ...
            "\n",
            {
                table: {
                    ...
                    body: [
                        ...
                        [{
                                text: '*Parental/guardian consent is required for all students under the age of 18.',
                                style: "textSmall",
                                bold: true,
                                colSpan: 3,
                                border: [false, false, false, false]
