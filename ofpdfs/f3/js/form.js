        ...
        footer: function (currentPage, pageCount) {
            return {
                table: {
                    widths: [150,330,50],
                    body: [
                        ["",{text:"Optimistic Futures Pty Ltd TOID:41053 | Skills First Program Enrolment Agreement Form – JAN 19 – V2.6" ,fontSize: 7}, { text: currentPage.toString() + ' of ' + pageCount, alignment: 'center', fontSize: 9, color: 'white', fillColor: "green" }]
                    ]
