        ...
        footer: function (currentPage, pageCount) {
            return {
                ...
                table: {
                    ...
                    widths: [60, 70, 350, 50],
                    body: [
                        [{ text: "", border: [false, false, false, false] }, { text: "", border: [false, true, false, false] }, { text: "Optimistic Futures Pty Ltd TOID:41053 | STUDENT INDUCTION FORM", fontSize: 7, border: [false, true, false, false], }, { text: currentPage.toString() + ' of ' + pageCount, alignment: 'center', fontSize: 9, color: 'white', fillColor: "green", border: [false, true, false, false] }]
                    ]
