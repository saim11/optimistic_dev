                ...
                columns: [ 
                    { 
                        ...
                        text: [
                            ...
                            { text: date[0], italics: true,fontSize: 8, bold: true },
                        ]
                    }
                ],
                margin: [190, 0]
            ...
            [
                {
                    table: {
                        widths: [341, 140],
                        body: [
                            [{ text: 'STUDENT INDUCTION FORM ', fontSize: 25, bold: true, alignment: "center", margin: [0, 20, 0, 0] },
                            {
                        ...
                        body: [
                            [{ text: 'Qualifications Name', margin: [0, 40, 0, 0], alignment: "center", bold: true, fillColor: "#808080", color: "white" },
                            {
                                table: {
                                    ...
                                    body: [
                                        [
                                            { image: box1, width: 17, height: 15, alignment: 'center' }, { text: 'Certificate III in Early Childhood Education and Care' }
                                        ],
                                        [
                                            { image: box2, width: 17, height: 15, alignment: 'center' }, { text: 'Diploma of Early Childhood Education and Care' }
                                        ],
                                        [
                                            { image: box3, width: 17, height: 15, alignment: 'center' }, { text: 'Certificate II in Security Operations' }
                                        ],
                                        [
                                            { image: box4, width: 17, height: 15, alignment: 'center' }, { text: 'Certificate III in Security Operations' }
                                        ],
                                        [
                                            { image: box5, width: 17, height: 15, alignment: 'center' }, { text: 'Certificate III in Individual Support' }
                                        ],
